...
if __name__ == "__main__":
    # === 3 capas finales ===
    merge_two_levels(files["ccaa_penin"], files["ccaa_can"], "ccaa_espana.geojson", "CCAA")
    merge_two_levels(files["prov_penin"], files["prov_can"], "provincias_espana.geojson", "Provincias")
    merge_two_levels(files["mun_penin"],  files["mun_can"],  "municipios_espana.geojson", "Municipios")
