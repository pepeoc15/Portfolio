...
def index(request):
    ...
    csv_path = DATA_DIR / "accidentes_dgt.csv"
    ...
    # geojson
    if level == "provincia":
        geo_path = GEO_DIR / "provincias.geojson"
    elif level == "ccaa":
        geo_path = GEO_DIR / "ccaa.geojson"
    else:
        geo_path = GEO_DIR / "municipios.geojson"
    ...
    return render(request, "dgt_acc_viz/index.html", {
        "form": form,
        "map_html": map_html,
